...
class CPFNet(nn.Module):
    def __init__(self,  nc=1, out_planes=1,ccm=True,norm_layer=nn.BatchNorm2d,is_training=True,expansion=2,base_channel=32):
        super(CPFNet,self).__init__()
        
        self.backbone =models.resnet34(pretrained=False)
        self.backbone.conv1= nn.Conv2d(nc, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)

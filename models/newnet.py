...
class FastSal(nn.Module):
    def __init__(self, pretrained=None):
        ...
        # self.conv1x1=nn.Conv2d(5, 1, 1, stride=1, padding=0)
    ...
    def forward(self, x): # (3, 1)
        ...
        out = torch.cat([output_main, output_side1, output_side2, output_side3, output_side4], dim=1)
        # print(output_main.shape)
        # out =self.conv1x1(out)
        return output_side1, output_side2, output_side3, output_side4, output_main   
...
class VAMM_backbone(nn.Module):
    def __init__(self, pretrained=None):
        ...
        #     self.load_state_dict(torch.load('/home/wangkun/shape-attentive-unet/models/pretrain/SAMNet_with_ImageNet_pretrain.pth'))
